# NOT YET IMPLEMENTED
# why not just use the http api. .... sockets is faster
...
class HermodBlueprint(Blueprint):
...
class HermodIOOutput(OutputChannel):
    @classmethod
    def name(cls) -> Text:
        return "hermodio"
...
class HermodIOInput(InputChannel):
    """A hermod input channel."""
