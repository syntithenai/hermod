...
if ARGS.actionserver > 0:
    #CONFIG['services']['RasaActionsServer']={}
...
def append_hermod_run_services(CONFIG,run_services):
    MODULE_DIR = os.getcwd()
...
print('OK')  
run_services = append_hermod_run_services(CONFIG,run_services)
print('services')      
print(run_services)
print(CONFIG)        

if run_services and len(run_services) > 0:
