...
class HermodDeepSpeechHotwordService extends HermodService  {
	...
	onRecog(siteId,results) {
		...
		if (results && results.indexOf(this.hotword) !== -1) {
			this.sendMqtt('hermod/'+siteId+'/hotword/detected',{hotword:results});			
		} else {
			console.log('ignore non hotword' + results)
		}
	}
...
module.exports=HermodDeepSpeechHotwordService
