...
class HermodPythonDeepSpeechAsrService extends HermodService  {
    ...
    constructor(props) {
		...
		let eventFunctions = {
            'hermod/+/asr/activate' : function(topic,siteId,payload) {
				...
				that.child[siteId] = require('child_process').spawn( 'deepspeech/bin/python' , ['./deepspeech/asr_exec.py','localhost','1883','jest',props.deepspeech_model_dir]); //, '--keywords picovoice', '--site '+props.siteId 
...
module.exports=HermodPythonDeepSpeechAsrService
